# Dashboard UI for retropanel

Web UI for [RetroPanel](https://github.com/RetroPanel/panel): large-scale proxy management that supports both [Xray-core](https://github.com/XTLS/Xray-core) and
...
## Install
    ...
    git clone https://github.com/RetroPanel/panel.git
...
| Name          | Description                                                                                 |
| ------------- | ------------------------------------------------------------------------------------------- |
| VITE_BASE_API | The api url of the deployed backend ([RetroPanel](https://github.com/RetroPanel/panel.git)) |
