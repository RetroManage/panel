  ...
  operatingSystems: [
    {
      ...
      apps: [
        ...
        },
        {
          ...
          faDescription: 'A client that provides a platform for routing traffic securely.',
        ...
        },
        {
          ...
          faDescription: 'A rule-based proxy utility client for iOS.',
      ...
      apps: [
        {
          ...
          faDescription: 'A V2Ray client for Android devices.',
      ...
      apps: [
        {
          ...
          faDescription: 'A Windows V2Ray client with GUI support.',
        ...
        },
        {
          ...
          faDescription: 'A cross-platform GUI client for clash core.',
    ...
    for (const app of os.apps) {
      ...
      apps.push({
        ...
        download_links: [
          ...
          { name: 'Download', url: app.downloadLink, language: 'fa' },
