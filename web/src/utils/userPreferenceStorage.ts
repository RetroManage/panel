...
const NUM_USERS_PER_PAGE_LOCAL_STORAGE_KEY = 'retropanel-num-users-per-page'
const NUM_ADMINS_PER_PAGE_LOCAL_STORAGE_KEY = 'retropanel-num-admins-per-page'
const NUM_ITEMS_PER_PAGE_DEFAULT = 10

const USERS_AUTO_REFRESH_INTERVAL_KEY = 'retropanel-users-auto-refresh-interval'
const DEFAULT_USERS_AUTO_REFRESH_INTERVAL_SECONDS = 15
const USERS_SHOW_CREATED_BY_KEY = 'retropanel-users-show-created-by'
const DEFAULT_USERS_SHOW_CREATED_BY = true
const USERS_SHOW_SELECTION_CHECKBOX_KEY = 'retropanel-users-show-selection-checkbox'
const DEFAULT_USERS_SHOW_SELECTION_CHECKBOX = true
const CHART_VIEW_TYPE_KEY = 'retropanel-chart-view-type'

const CORES_LIST_USE_CONFIG_MODAL_KEY = 'retropanel-cores-list-use-config-modal'
const DEFAULT_CORES_LIST_USE_CONFIG_MODAL = false

export const DATE_PICKER_PREFERENCE_KEY = 'retropanel-date-picker-preference'
...
export const CHART_VIEW_TYPE_CHANGE_EVENT = 'retropanel-chart-view-type-change'
